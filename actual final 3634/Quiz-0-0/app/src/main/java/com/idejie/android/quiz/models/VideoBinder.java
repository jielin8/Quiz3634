    ...
    public void bind(final VideoViewHolder videoViewHolder, final IFragmentManager fragmentManager) {
        ...
        if (imageRequest == null) {
            videoViewHolder.image.post(new Runnable() {
                @Override
                public void run() {
                    ImageRequestBuilder builder = ImageRequestBuilder.newBuilderWithResourceId(android.R.color.darker_gray);
            ...
            public void onClick(View view) {
                ...
                if (viewHolder.videoContainer.getChildCount() == 0) {
                    ...
                    fragmentManager.getSupportFragmentManager()
                            ...
                            .commit();
                    youTubePlayerFragment.initialize("AIzaSyA9keNvDfQajJ53PyLdZ7BuQkjotXn1aJg",
